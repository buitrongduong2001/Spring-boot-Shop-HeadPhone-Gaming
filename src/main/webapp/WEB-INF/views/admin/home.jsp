            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Thông Kế Shop HeadPhone</h1>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Doanh thu theo tháng (Monthly)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <fmt:setLocale value="vi_VN" scope="session" />
                                                <fmt:formatNumber var="revenueMonth" value="${month}" type="currency" />
                                                ${revenueMonth}
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Doanh thu theo năm (Annual)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <fmt:setLocale value="vi_VN" scope="session" />
                                                <fmt:formatNumber var="revenueYear" value="${year}" type="currency" />
                                                ${revenueYear}
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <fmt:setLocale value="vi_VN" scope="session" />
                                                <fmt:formatNumber var="revenue" value="${total}" type="currency" />
                                                ${revenue}
                                            </div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        ...
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> Zalo Pay
                                        </span>
                                    </div>
                                </div>
                            </div>
