...
<!-- Main-->
<main>
    <div class="result-search">Kết quả tìm kiếm cho ‘${param.get('keyword')}’</div>
                    ...
                    <div class="category_silde_bar_menu_container">
                        <ul class="category_silde_bar_menu_ul menu">
                            <c:forEach var="item" items="${listCate}">
                                <c:choose>
                                    <c:when test="${param.get('parent') == item.id}">
                                        <li class="category_silde_bar_menu_li active">
                                            <a href="${base}/tim-kiem?parent=${item.id}&keyword=${param.get('keyword')}" class="category_silde_bar_menu_link"> ${item.name} </a>
                                        </li>
                                    </c:when>
                                    <c:otherwise>
                ...
                <aside class="category_filter_price">
                    ...
                    <c:choose>
                        <c:when test="${param.get('parent') == null}">
                            <form method="get" action="${base}/tim-kiem">
                                <input type="hidden" name="keyword" value="${param.get('keyword')}">
        ...
        <div class="col-lg-9 col-md-12 category_silde_bar_item">
            ...
            <form action="${base}/tim-kiem" method="get" >
                ...
                <c:if test="${param.get('keyword') != null}">
                    <input class="form-check-input" value="${param.get('keyword')}" type="hidden" name="keyword"/>
                </c:if>
