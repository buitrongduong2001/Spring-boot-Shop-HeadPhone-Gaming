                                ...
                                <tr>
                                    <td
                                        ...
                                        <table id="m_5417975229659139961nddh"
                                            ...
                                            <#list ${sanPham.saleOrderProducts} as data>
                                            <tr >
                                                ...
                                                <td style="padding:4px">
                                                    <#if ${data.products.priceSale} == null>
                                                    <#setting number_format="currency">
                                                    <#assign x=data.products.price>
                                                        ${x}
                                                    </#if>
                                                    <#if ${data.products.priceSale} != null>
                                                <#setting number_format="currency">
                                                <#assign x=data.products.priceSale>
                                                        ${x}
                                                    </#if>
                                                </td>
                                                <td style="padding:4px" >${data.quantity}</td>
                                                <td style="padding:4px;font-weight:bold">
                                                    <#if ${data.products.priceSale} == null>
                                                    ${data.products.price * data.quantity}
                                                    </#if>
                                                    <#if ${data.products.priceSale} != null>
                                                    ${data.products.priceSale * data.quantity}
                                                    </#if>
                                                </td>
                                            </tr>
                                            </#list>
